  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[1.05fr_1fr]">
      ...
      <aside className="relative hidden lg:flex flex-col justify-between overflow-hidden text-white bg-brand-gradient p-12 xl:p-16">
        ...
        {/* Bottom: refined testimonial line */}
        ...
        <div className="relative z-10 flex-1 grid place-items-center px-6 py-14 lg:px-16">
          <div className="w-full max-w-[420px]">
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-paper hairline border rounded-xl text-[15px] text-ink-900 placeholder:text-ink-400 shadow-[0_1px_0_rgba(54,52,45,0.04)] ring-focus transition-shadow"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full pl-11 pr-12 py-3.5 bg-paper hairline border rounded-xl text-[15px] text-ink-900 placeholder:text-ink-400 shadow-[0_1px_0_rgba(54,52,45,0.04)] ring-focus transition-shadow"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                className="group mt-2 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-ink-900 hover:bg-ink-800 text-white font-medium text-[15px] py-3.5 shadow-[0_8px_24px_-12px_rgba(18,18,16,0.6)] transition-all active:scale-[0.99] focus:outline-none focus:ring-4 focus:ring-ink-900/15"
              >
                Sign in
                <LuArrowRight
                  size={18}
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-paper hairline border hover:bg-ink-50 text-ink-700 font-medium py-3.5 transition-colors"
              >
                <LuBuilding2 size={18} strokeWidth={1.75} className="text-ink-500" />
                Continue with SSO
              </button>
            </form>
