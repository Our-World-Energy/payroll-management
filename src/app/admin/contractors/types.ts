...
export const COLUMNS: ColumnDef[] = [
  ...
  { key: "department",     label: "Assigned Team",   type: "string" },
  { key: "subDepartment",  label: "Functional Team", type: "string" },
  { key: "role",           label: "Role",            type: "string" },
  { key: "location",       label: "Location",        type: "string" },
  { key: "status",         label: "Status",          type: "string" },
  { key: "hireDate",       label: "Engagement Start Date", type: "date"   },
  { key: "officeLocation", label: "Work Location",   type: "string" },
  { key: "currency",       label: "Currency",        type: "string" },
  { key: "monthlyRate",    label: "Monthly Contract Rate",    type: "number" },
  { key: "weeklyRate",     label: "Weekly Contract Rate",     type: "number" },
  { key: "hourlyRate",     label: "Hourly Rate",     type: "number" },
  { key: "email",          label: "Email",           type: "string" },
  { key: "payCategory",    label: "Pay Category",    type: "string" },
  { key: "shiftHours",     label: "Agreed Schedule", type: "string" },
  { key: "restDay",        label: "Typical Non-Working Days", type: "string" },
  { key: "manager",        label: "OWE Contact",      type: "string" },
  { key: "payPeriod",      label: "Pay Cycle",      type: "string" },
